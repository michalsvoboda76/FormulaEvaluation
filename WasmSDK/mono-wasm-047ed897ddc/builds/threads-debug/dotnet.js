...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 707472,
    DYNAMIC_BASE = 5950352,
    DYNAMICTOP_PTR = 706544;
...
var ASM_CONSTS = {
  78090: function($0, $1, $2) {MONO.mono_wasm_add_typed_value ('pointer', $0, { ptr_addr: $1, klass_addr: $2 });},  
 78183: function($0, $1, $2) {MONO.mono_wasm_add_typed_value ('array', $0, { objectId: $1, length: $2 });},  
 590920: function() {return STACK_MAX;},  
 590942: function() {return TOTAL_STACK;},  
 651096: function() {throw 'Canceled!'},  
 651316: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);},  
 651646: function($0, $1) {MONO.string_decoder.decode($0, $0 + $1, true);},  
 651930: function($0, $1, $2) {var str = MONO.string_decoder.decode ($0, $0 + $1); try { var res = eval (str); if (res === null || res == undefined) return 0; res = res.toString (); setValue ($2, 0, "i32"); } catch (e) { res = e.toString (); setValue ($2, 1, "i32"); if (res === null || res === undefined) res = "unknown exception"; } var buff = Module._malloc((res.length + 1) * 2); stringToUTF16 (res, buff, (res.length + 1) * 2); return buff;},  
 652349: function() {var err = new Error(); console.log ("Stacktrace: \n"); console.log (err.stack);}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=707456;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 706704;
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 706608, 4), 706608);function _gmtime_r(time, tmPtr) {
